...
// Last run: 2026-09-14 · 277 live models · 9 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-14'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.6832,
    "outputPricePerMillion": 2.1472,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-09-14",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.683 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.68/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [

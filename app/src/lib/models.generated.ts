...
// Last run: 2026-08-09 · 263 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-09'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "outputPricePerMillion": 0.308,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "fast",
    "updatedAt": "2026-08-09",
    "description": "GLM 5.2 is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.098 per million input tokens with a 1M-token context window.",
    "strengths": [

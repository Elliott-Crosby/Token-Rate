...
// Last run: 2026-09-25 · 286 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-25'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-25",
    "description": "GLM 5.3 Flash is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.045 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.049/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.783,
    "outputPricePerMillion": 1.566,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-25",

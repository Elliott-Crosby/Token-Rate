...
// Last run: 2026-09-26 · 285 live models · 14 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-26'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.018/1M input tokens",
      "Low latency for high-throughput workloads",
      "Cost-effective at scale"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.019/1M input tokens",
      "Low latency for high-throughput workloads",
      "Cost-effective at scale"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.021/1M input tokens",
  ...
  },
  {
    ...
    "weaknesses": [
      "Less capable than flagship models on complex reasoning",
      "Smaller 60K-token context limits long-document use"
    ],
    "useCases": [
      "High-volume classification",
      "Text extraction and summarization",
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "GLM 5.3 Flash is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.040 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "outputPricePerMillion": 0.177,
    "contextWindow": 8192,
    "outputLimit": 4096,
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Hy-MT2-1.8B is a compact 1.8B-parameter translation model from Tencent.",
    "strengths": [
      "Extremely cheap at $0.044/1M input tokens",
      "Low latency for high-throughput workloads",
      "Cost-effective at scale"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.047/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Solar Mini 4 is Upstage's compact, cost-efficient language model, a 35B-parameter mixture-of-experts with 3B active parameters and a 524K context window.",
    "strengths": [
      "Extremely cheap at $0.050/1M input tokens",
      "Large 524K-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
      "Less capable than flagship models on complex reasoning",
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Granite 4.2 8B is a dense reasoning model from IBM. It is suited for mathematics, code generation, multilingual dialogue, and agentic workflows that need multi-step reasoning.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "Google",
    "providerSlug": "google",
    "inputPricePerMillion": 0.0675,
    "outputPricePerMillion": 0.225,
    "contextWindow": 262144,
    "outputLimit": 235929,
    "tier": "fast",
    "updatedAt": "2026-09-26",
    ...
    "strengths": [
      "Extremely cheap at $0.068/1M input tokens",
      "Large 262K-token context window",
      "Low latency for high-throughput workloads",
      "Multimodal: understands images as well as text"
    ],
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Hy-MT2-30B-A3B is Tencent's flagship translation model in the Hy-MT2 family.",
    "strengths": [
      "Extremely cheap at $0.074/1M input tokens",
      "Low latency for high-throughput workloads",
      "Cost-effective at scale"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.087/1M input tokens",
      "Large 262K-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Solar Pro 4 is Upstage's cost-efficient large language model, featuring a 524K context window.",
    "strengths": [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.094/1M input tokens",
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Luna Pro is the same underlying model as GPT-6 Luna, served with `reasoning. mode` set to `pro` for higher-quality responses on complex tasks.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Luna is the fast, cost-efficient model in OpenAI's GPT-6 series, positioned below GPT-6 Sol.",
    "strengths": [
      "Extremely cheap at $0.100/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads",
  ...
  },
  {
    ...
    "provider": "Tencent",
    "providerSlug": "tencent",
    "inputPricePerMillion": 0.132,
    "outputPricePerMillion": 0.528,
    "contextWindow": 262144,
    "outputLimit": 128000,
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Hy3 is a 295B-parameter Mixture-of-Experts model from Tencent (21B active, 192 experts with top-8 routing) built for reasoning, agentic workflows, and real-world production use.",
    "strengths": [
      "Extremely cheap at $0.132/1M input tokens",
      "Large 262K-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Qwen3.8 Omni Flash is an omni-modal reasoning model from Alibaba, the first Qwen model built around agentic capabilities with native audio-video understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "NVIDIA Nemotron 3.5 Content Safety is a compact 4B-parameter multimodal guardrail model from NVIDIA, fine-tuned from Google Gemma-3-4B.",
    "strengths": [
      "Extremely cheap at $0.200/1M input tokens",
      "Low latency for high-throughput workloads",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "DeepSeek V4 Flash Vision Exp is an experimental vision-enabled version of DeepSeek V4 Flash 0731 from DeepSeek, adding image understanding while matching the base model on text capabilities including agents.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.264,
    "outputPricePerMillion": 0.792,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-26",
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Command A+ is Cohere's flagship model for enterprise agentic workflows.",
    "strengths": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.31/1M input tokens",
      "Large 262K-token context window",
      "Low latency for high-throughput workloads",
      "Multimodal: understands images as well as text"
    ],
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.3581,
    "outputPricePerMillion": 0.7162,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-26",
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "GLM-5.3-FlashX is the high-speed variant of Z. ai's GLM-5.3-Flash, a native multimodal model delivering inference speeds of up to 200 tokens/s.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.3794,
    "outputPricePerMillion": 1.1924,
    "contextWindow": 1310720,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "GLM-5.3 is a large-scale reasoning model from Z. ai, built for complex software engineering and long-horizon agent tasks.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Seed 2.1 Turbo is a multimodal model from ByteDance Seed for coding and long-horizon agent workflows.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Seed 2.0 Code is a model from ByteDance Seed optimized for agentic coding.",
    "strengths": [
      "Affordable at $0.50/1M input tokens",
      "Large 262K-token context window",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-26",
    "description": "Nano Banana 2 (Gemini 3.1 Flash Image Preview) is Google's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.500 per million input tokens with a 66K-token context window and native image understanding.",
    "strengths": [
      "Affordable at $0.50/1M input tokens",
      "Low latency for high-throughput workloads",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.6496,
    "outputPricePerMillion": 2.0416,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.650 per million input tokens with a 1M-token context window.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "Moonshot AI",
    "providerSlug": "moonshot",
    "inputPricePerMillion": 0.6562,
    "outputPricePerMillion": 3.3,
    "contextWindow": 262144,
    "outputLimit": 235929,
    "tier": "balanced",
    "updatedAt": "2026-09-26",
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Tencent: Hy4 preview is a mixture-of-experts model from Tencent, with 49B active parameters out of 770B total.",
    "strengths": [
      "Affordable at $0.83/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.95/1M input tokens",
      "Large 262K-token context window",
      "Multimodal: understands images as well as text"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.9646,
    "outputPricePerMillion": 3.0316,
    "contextWindow": 204800,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    ...
    "strengths": [
      "Affordable at $0.96/1M input tokens",
      "Large 205K-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Grok Build 0.1 is SpaceXAI’s fast coding model trained specifically for agentic software engineering workflows.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Grok 4.20 Multi-Agent is a variant of SpaceXAI’s Grok 4.20 designed for collaborative, agent-based workflows.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Grok 4.20 is a reasoning model from SpaceXAI with industry-leading speed and agentic tool calling capabilities.",
    "strengths": [
      "Massive 2M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Grok 4.7 is SpaceXAI's flagship model for coding, agentic tasks, and knowledge work, succeeding Grok 4.6.",
    "strengths": [
      "Large 500K-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Sol Pro is the same underlying model as GPT-6 Sol, served with `reasoning. mode` set to `pro` for higher-quality responses on complex tasks.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Sol is the cost-efficient high-end model in OpenAI's GPT-6 series, positioned below the flagship GPT-6 Astra and above the fast GPT-6 Luna tier.",
    "strengths": [
      "Massive 1M-token context window",
      "Multimodal: understands images as well as text",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Qwen3.8 Max 0902 is an updated snapshot of Qwen3.8 Max from Alibaba's Qwen team.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Qwen3.8 2.4T A95B is an open-weight sparse mixture-of-experts model from Qwen and the open-weight variant of Qwen3.8 Max, with 95 billion active parameters out of 2.4 trillion total.",
    "strengths": [
      "Massive 1M-token context window",
      "Strong general-purpose performance",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Grok 4.6 is a model from SpaceXAI with frontier performance on coding, knowledge work, and STEM. It is succeeded by Grok 4.7.",
    "strengths": [
      "Large 500K-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "outputPricePerMillion": 8.8,
    "contextWindow": 1000000,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "GLM-5.3-Prime is the high-speed variant of Z. ai's GLM-5.3, inheriting its full capabilities while delivering 1.5–2× the output throughput through inference acceleration.",
    "strengths": [
      "Massive 1M-token context window",
      "Strong general-purpose performance",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-26",
    "description": "Kimi K3 is a 2.8T parameter open-weight multimodal reasoning model from Moonshot AI.",
    "strengths": [
      "Massive 1M-token context window",
      "Multimodal: understands images as well as text",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Qwen3.8 Max Prime is a higher-throughput variant of Qwen3.8 Max from Alibaba's Qwen team, served as a separate SKU at a higher price point.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "Claude Opus 5.5 is Anthropic's flagship model for demanding reasoning, coding, and long-horizon agentic work, succeeding Claude Opus 5.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Astra is OpenAI's flagship model for demanding end-to-end work.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-26",
    "description": "GPT-6 Astra Pro is the same underlying model as GPT-6 Astra, served with `reasoning. mode` set to `pro` for higher-quality responses on complex tasks.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"

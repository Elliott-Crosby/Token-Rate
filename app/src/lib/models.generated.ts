...
// Last run: 2026-08-05 · 262 live models · 11 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-05'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.73/1M input tokens",
      "Large 262K-token context window",
      "Multimodal: understands images as well as text"
    ],
    "weaknesses": [

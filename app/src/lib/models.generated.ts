...
// Last run: 2026-07-17 · 267 live models · 4 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-17'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.9324,
    "outputPricePerMillion": 2.9304,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-07-17",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.932 per million input tokens with a 1M-token context window.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-07-17",
    "description": "Kimi K3 is an ultra-large-scale, open-weight multimodal reasoning model from Moonshot AI.",
    "strengths": [
      "Massive 1M-token context window",
      "Multimodal: understands images as well as text",
      "Strong general-purpose performance"

...
// Last run: 2026-09-16 · 275 live models · 9 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-16'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-16",
    "description": "GLM 5.3 Flash is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.100 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.63/1M input tokens",
      "Large 262K-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.9834,
    "outputPricePerMillion": 2.9502,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-16",
    ...
    "strengths": [
      "Affordable at $0.98/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-16",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $1.40 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Massive 1M-token context window",
      "Strong general-purpose performance",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "provider": "Moonshot AI",
    "providerSlug": "moonshot",
    "inputPricePerMillion": 2.6481,
    "outputPricePerMillion": 13.2827,
    "contextWindow": 1048576,
    "outputLimit": 943718,
    "tier": "balanced",
    "updatedAt": "2026-09-16",

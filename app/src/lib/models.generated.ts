...
// Last run: 2026-08-23 · 276 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-23'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "inputPricePerMillion": 0.0517,
    "outputPricePerMillion": 0.1033,
    ...
    "strengths": [
      "Extremely cheap at $0.052/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.3969,
    "outputPricePerMillion": 0.7938,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-08-23",

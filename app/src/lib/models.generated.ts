...
// Last run: 2026-06-10 · 203 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-06-10'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-06-10",
    "description": "Qwen3.7 Plus is Qwen's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.400 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.48/1M input tokens",
      "Low latency for high-throughput workloads",
      "Cost-effective at scale"
    ],
    "weaknesses": [

...
// Last run: 2026-09-10 · 277 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-10'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-10",
    "description": "DeepSeek V4.1 Flash is a sparse mixture-of-experts model from DeepSeek, and the cost-efficient tier of the V4.1 family.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-10",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.966 per million input tokens with a 1M-token context window.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 1.0494,
    "outputPricePerMillion": 3.1482,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-10",

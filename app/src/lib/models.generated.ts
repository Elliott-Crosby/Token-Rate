...
// Last run: 2026-07-13 · 267 live models · 9 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-13'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-07-13",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.930 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.93/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [

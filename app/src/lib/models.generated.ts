...
// Last run: 2026-07-19 · 265 live models · 4 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-19'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.2758,
    "outputPricePerMillion": 0.8668,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "fast",
    "updatedAt": "2026-07-19",
    "description": "GLM 5.2 is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.276 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.28/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.85/1M input tokens",
      "Large 262K-token context window",
      "Multimodal: understands images as well as text"
    ],
    "weaknesses": [

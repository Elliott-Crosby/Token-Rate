...
// Last run: 2026-08-16 · 271 live models · 11 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-16'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "inputPricePerMillion": 0.0615,
    "outputPricePerMillion": 0.1229,
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.308,
    "outputPricePerMillion": 0.968,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "balanced",
    "updatedAt": "2026-08-16",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.308 per million input tokens with a 1M-token context window.",
    "strengths": [

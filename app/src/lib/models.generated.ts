...
// Last run: 2026-08-24 · 276 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-24'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "inputPricePerMillion": 0.0574,
    "outputPricePerMillion": 0.1148,
    ...
    "strengths": [
      "Extremely cheap at $0.057/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.5262,
    "outputPricePerMillion": 1.0524,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-08-24",
    ...
    "strengths": [
      "Affordable at $0.53/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [

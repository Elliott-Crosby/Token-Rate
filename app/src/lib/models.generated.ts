...
// Last run: 2026-08-27 · 278 live models · 0 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-27'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.078,
    "outputPricePerMillion": 0.156,
    ...
    "strengths": [
      "Extremely cheap at $0.078/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.87/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 1.122,
    "outputPricePerMillion": 3.366,
    "contextWindow": 1048576,
    "outputLimit": 943717,
    "tier": "flagship",
    "updatedAt": "2026-08-27",

...
// Last run: 2026-09-01 · 276 live models · 5 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-01'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.0809,
    "outputPricePerMillion": 0.1618,
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-01",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $1.19 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Massive 1M-token context window",
      "Strong general-purpose performance",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "tier": "flagship",
    "updatedAt": "2026-09-01",
    "description": "Fast-mode variant of Opus 5 - identical capabilities with higher output speed at 2x pricing relative to regular Opus 5. Learn more in Anthropic's docs: https://platform.",
    "strengths": [
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks",
      "Multimodal: understands images as well as text"

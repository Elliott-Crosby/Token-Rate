...
// Last run: 2026-09-12 · 277 live models · 22 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-12'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "strengths": [
      "Extremely cheap at $0.042/1M input tokens",
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.0668,
    "outputPricePerMillion": 0.1336,
    ...
    "strengths": [
      "Extremely cheap at $0.067/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-12",
    "description": "GLM 5.3 Flash is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.075 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-12",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.600 per million input tokens with a 1M-token context window.",
    "strengths": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.7992,
    "outputPricePerMillion": 1.5984,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-12",
  ...
  },
  {
    ...
    "provider": "Moonshot AI",
    "providerSlug": "moonshot",
    "inputPricePerMillion": 2.3027,
    "outputPricePerMillion": 11.5502,
    "contextWindow": 1048576,
    "outputLimit": 943718,
    "tier": "balanced",
    "updatedAt": "2026-09-12",

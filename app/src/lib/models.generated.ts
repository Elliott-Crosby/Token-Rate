...
// Last run: 2026-07-30 · 265 live models · 17 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-30'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.6993,
    "outputPricePerMillion": 2.1978,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "balanced",
    "updatedAt": "2026-07-30",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.699 per million input tokens with a 1M-token context window.",
    "strengths": [

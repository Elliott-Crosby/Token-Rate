...
// Last run: 2026-08-29 · 275 live models · 22 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-29'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.0834,
    "outputPricePerMillion": 0.1669,
    ...
    "strengths": [
      "Extremely cheap at $0.083/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.6301,
    "outputPricePerMillion": 1.2601,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-08-29",

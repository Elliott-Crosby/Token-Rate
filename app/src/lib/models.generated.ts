...
// Last run: 2026-07-14 · 267 live models · 9 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-14'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.9282,
    "outputPricePerMillion": 2.9172,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "balanced",
    "updatedAt": "2026-07-14",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.928 per million input tokens with a 1M-token context window.",
    "strengths": [

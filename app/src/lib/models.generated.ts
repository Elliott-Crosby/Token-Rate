...
// Last run: 2026-07-11 · 267 live models · 9 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-11'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "inputPricePerMillion": 0.077,
    "outputPricePerMillion": 0.154,
    ...
    "strengths": [
      "Extremely cheap at $0.077/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.2145,
    "outputPricePerMillion": 0.3217,
    "contextWindow": 131072,
    "outputLimit": 64000,
    "tier": "fast",
    "updatedAt": "2026-07-11",
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.406,
    "outputPricePerMillion": 1.276,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "balanced",
    "updatedAt": "2026-07-11",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.406 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.41/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [

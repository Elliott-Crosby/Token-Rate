...
// Last run: 2026-07-21 · 265 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-21'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.82/1M input tokens",
      "Large 262K-token context window",
      "Multimodal: understands images as well as text"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.9436,
    "outputPricePerMillion": 2.9656,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-07-21",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.944 per million input tokens with a 1M-token context window.",
    "strengths": [

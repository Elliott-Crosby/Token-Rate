...
// Last run: 2026-07-10 · 269 live models · 11 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-07-10'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-07-10",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.840 per million input tokens with a 1M-token context window.",
    "strengths": [

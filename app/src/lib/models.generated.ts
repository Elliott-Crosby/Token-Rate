...
// Last run: 2026-08-08 · 263 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-08'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.3024,
    "outputPricePerMillion": 0.9504,
    "contextWindow": 1048576,
    "outputLimit": 128000,
    "tier": "balanced",
    "updatedAt": "2026-08-08",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.302 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.30/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
  ...
  },
  {
    ...
    "provider": "Moonshot AI",
    "providerSlug": "moonshot",
    "inputPricePerMillion": 0.5795,
    "outputPricePerMillion": 2.44,
    "contextWindow": 262144,
    "outputLimit": 262144,
    "tier": "balanced",
    "updatedAt": "2026-08-08",

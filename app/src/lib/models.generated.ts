...
// Last run: 2026-09-24 · 285 live models · 7 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-24'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.0886,
    "outputPricePerMillion": 0.1772,
    ...
    "strengths": [
      "Extremely cheap at $0.089/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "tier": "fast",
    "updatedAt": "2026-09-24",
    "description": "GLM 5.3 Flash is Zhipu AI's a fast, low-cost model tuned for high-throughput tasks like classification, extraction, and simple chat. It costs $0.150 per million input tokens with a 1M-token context window and native image understanding.",
    "strengths": [
      "Extremely cheap at $0.150/1M input tokens",
      "Massive 1M-token context window",
      "Low latency for high-throughput workloads",
  ...
  },
  {
    ...
    "name": "Mistral Large 3 2512 (batch)",
    "provider": "Mistral",
    "providerSlug": "mistral",
    "inputPricePerMillion": 0.25,
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.462,
    "outputPricePerMillion": 1.386,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-24",
    ...
    "strengths": [
      "Affordable at $0.46/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "strengths": [
      "Affordable at $0.84/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.9396,
    "outputPricePerMillion": 1.8792,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-09-24",
    ...
    "strengths": [
      "Affordable at $0.94/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [

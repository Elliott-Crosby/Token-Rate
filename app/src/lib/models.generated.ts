...
// Last run: 2026-08-28 · 277 live models · 0 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-28'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.0868,
    "outputPricePerMillion": 0.1736,
  ...
  },
  {
    ...
    "provider": "DeepSeek",
    "providerSlug": "deepseek",
    "inputPricePerMillion": 0.7619,
    "outputPricePerMillion": 1.5239,
    "contextWindow": 1048576,
    "outputLimit": 384000,
    "tier": "flagship",
    "updatedAt": "2026-08-28",
    ...
    "strengths": [
      "Affordable at $0.76/1M input tokens",
      "Massive 1M-token context window",
      "Frontier-class quality on complex tasks"
    ],
    "weaknesses": [

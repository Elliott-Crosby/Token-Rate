...
// Last run: 2026-08-02 · 261 live models · 10 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-08-02'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "provider": "Zhipu AI",
    "providerSlug": "zhipu",
    "inputPricePerMillion": 0.3136,
    "outputPricePerMillion": 0.9856,
    "contextWindow": 1048576,
    "outputLimit": 131072,
    "tier": "balanced",
    "updatedAt": "2026-08-02",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.314 per million input tokens with a 1M-token context window.",
    "strengths": [

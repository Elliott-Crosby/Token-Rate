...
// Last run: 2026-09-18 · 275 live models · 6 with quality scores.
import type { ModelData } from './models'

export const LIVE_UPDATED_AT = '2026-09-18'
...
export const EXTRA_MODELS: ModelData[] = [
  ...
  },
  {
    ...
    "tier": "balanced",
    "updatedAt": "2026-09-18",
    "description": "GLM 5.2 is Zhipu AI's a balanced model that trades a little peak capability for much lower cost and faster responses. It costs $0.563 per million input tokens with a 1M-token context window.",
    "strengths": [
      "Affordable at $0.56/1M input tokens",
      "Massive 1M-token context window",
      "Strong general-purpose performance"
    ],
    "weaknesses": [

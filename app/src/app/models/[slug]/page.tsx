        ...
        <div className="flex flex-col gap-12">
          ...
          <RelatedPages
            ...
            pages={[
              ...
              { href: '/blog/cost-optimization/prompt-caching-save-90-percent-on-ai-costs', label: 'Prompt Caching', description: 'Calculate savings from measured cache hits and provider rates.' },
            ]}
          />
        </div>
      </div>
